...
const navbar = () => {
  ...
  const [isOpen, setIsOpen] = useState(false); //use to check menu is open or not 
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"
      ...
      <div className='text-white py-5 flex justify-between item-center'>
        ...
        {/*Desktop:-> Now handling navigation text print */}
        <ul className="hidden md:flex space-x-8 text-gray-300">
          {menuItems.map((item) => {
            return <li key={item.id} className={`cursor-pointer hover:text-[#8245ec] ${activeSection === item.id ? "text-[#8245ec]" : ""
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/mayankgupta450/my-portfolio"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/mayank-gupta-74b955182/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
