...
import { experiences } from "../../staticdata/staticdata";
...
const experience = () => {
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Vertical line */}
        <div className="absolute left-1/2 -translate-x-1/2 w-1 bg-gradient-to-b from-purple-500 via-pink-500 to-blue-500 shadow-[0_0_30px_5px_rgba(130,69,236,0.6)] h-full"></div>
  ...
  transform transition-transform duration-300 hover:scale-[1.03] hover:shadow-[0_0_35px_8px_rgba(130,69,236,0.6)]
